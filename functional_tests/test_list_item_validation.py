...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        # Соня начинает набирать текст нового элемента и ошибка исчезает
    ...
    def test_error_massages_are_cleared_on_input(self):
        ...
        # Соня начинает список и вызывает ошибку валидации
        ...
        # Она начинает набирать в поля ввода, чтобы очистить ошибку
        self.get_item_input_box().send_keys('a')

        # Она довольна от того, что сообщение об ошибки исчизает
